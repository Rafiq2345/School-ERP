...
Financial records in the School ERP govern student fee receivables, cash receipts, bank collections, scholarship settlements, payroll disbursements, and double-entry general ledgers across all licensed school tenants.
...
- **Phase 1 (Inspection & Preview)**:
  - Scans all target vouchers within the tenant.
