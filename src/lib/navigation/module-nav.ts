...
export const MODULE_NAV_CONFIGS: Record<string, ModuleNavConfig> = {
  ...
  students: {
    ...
    items: [
      { id: 'directory', label: 'Directory', labelUr: 'طلباء لسٹ', href: '/admin/students', icon: Users },
      { id: 'admission', label: 'New Admission', labelUr: 'نیا داخلہ', href: '/admin/students/new', icon: UserPlus },
      { id: 'bulk', label: 'Bulk Operations', labelUr: 'بلک آپریشنز', href: '/admin/students/bulk', icon: ArrowRightLeft },
      { id: 'audit', label: 'Student Audit', labelUr: 'طالب علم آڈٹ', href: '/admin/students/audit', icon: History, isAudit: true },
  ...
  settings: {
    moduleCode: 'CONFIG',
    moduleName: 'Admin Config',
    moduleNameUr: 'انتظامی ترتیبات',
    ...
    items: [
      ...
      { id: 'subjects', label: 'Subjects', labelUr: 'مضامین', href: '/admin/settings/subjects', icon: BookOpen },
      { id: 'curriculum', label: 'Curriculum', labelUr: 'نصاب', href: '/admin/settings/class-subjects', icon: Network },
      { id: 'roles', label: 'Roles & Permissions', labelUr: 'اختیارات', href: '/admin/settings/roles', icon: Shield },
      { id: 'modules', label: 'Module Settings', labelUr: 'ماڈیولز', href: '/admin/settings/modules', icon: Package },
      { id: 'subscription', label: 'Software Subscription', labelUr: 'سافٹ ویئر سبسکرپشن', href: '/admin/settings/subscription', icon: CreditCard },
      { id: 'audit', label: 'Audit', labelUr: 'آڈٹ', href: '/admin/settings/audit', icon: History, isAudit: true },
