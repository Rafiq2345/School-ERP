  ...
  // 1. ORGANIZATION & SCHOOL (DEFAULT)
  {
    ...
    cards: [
      ...
      },
      {
        ...
        badge: 'Tier 2 Division (Optional)',
        badgeType: 'default',
      ...
      },
      {
        id: 'zones',
        title: 'Zones & Areas',
        description: 'Configure cluster-level academic and operational zones across regions or directly attached to head offices.',
        href: '/admin/settings/zones',
        badge: 'Tier 3 Cluster (Optional)',
        badgeType: 'default',
        params: ['Zone Code', 'Zone Manager Desk', 'Cluster Coverage', 'Direct / Regional Attachment'],
